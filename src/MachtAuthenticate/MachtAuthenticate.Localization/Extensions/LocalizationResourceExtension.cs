...
namespace MachtAuthenticate.Localization.Extensions
{
    ...
    public class LocalizationResourceExtension : NestedMarkupExtension, INotifyPropertyChanged, IDictionaryEventListener, IDisposable
    {
        ...
        public static LocalizationResourceExtension GetBoundExtension(object target, string property, int propertyIndex = -1)
        {
            foreach (var ext in LocalizeDictionary.DictionaryEvent.EnumerateListeners<LocalizationResourceExtension>())
            {
        ...
        {
            get { return _converter ?? (_converter = new DefaultConverter()); }
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="LocalizationResourceExtension" /> class.
        /// </summary>
        ...
        public LocalizationResourceExtension(string key)
            : this()
        {
            Key = key;
        }
        ...
        ///     or <see cref="PropertyInfo" /> and the <c>LocalizationResourceExtension</c>.
        /// </summary>
