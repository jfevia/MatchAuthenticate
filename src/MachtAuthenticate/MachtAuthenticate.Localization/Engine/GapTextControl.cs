...
namespace MachtAuthenticate.Localization.Engine
{
    ...
    public class GapTextControl : Control
    {
        ...
        /// <summary>
        ///     Pattern to split the FormatString, see
        ///     https://github.com/SeriousM/WPFLocalizationExtension/issues/78#issuecomment-163023915 for documentation ( TODO!!!)
        /// </summary>
        ...
        /// <summary>
        ///     If this property is true, any FormatString that refers to the same string item multiple times produces an
        ///     exception.
        /// </summary>
        ...
        /// <summary>
        ///     If this property is true, any FormatString that refers to the same control item multiple times produces an
        ///     exception.
        /// </summary>
        ...
        private void AttachToVisualTree()
        {
            if (Template != null)
            {
                ...
                if (!Equals(textBlock, _theTextBlock))
                {
