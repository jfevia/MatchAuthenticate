...
using MachtAuthenticate.Localization.Providers;
using XAMLMarkupExtensions.Base;

// Register this namespace one with prefix

[assembly: XmlnsDefinition("http://wpflocalizeextension.codeplex.com", "MachtAuthenticate.Localization.Engine")]
[assembly: XmlnsDefinition("http://wpflocalizeextension.codeplex.com", "MachtAuthenticate.Localization.Extensions")]
[assembly: XmlnsDefinition("http://wpflocalizeextension.codeplex.com", "MachtAuthenticate.Localization.Providers")]
[assembly: XmlnsDefinition("http://wpflocalizeextension.codeplex.com", "MachtAuthenticate.Localization.TypeConverters")]

// Assign a default namespace prefix for the schema

[assembly: XmlnsPrefix("http://schemas.jfevia.com/wpf/xaml", "jfevia")]
...
namespace MachtAuthenticate.Localization.Engine
{
    ...
    public sealed class LocalizeDictionary : DependencyObject, INotifyPropertyChanged
    {
        ...
        {
            var value = args.NewValue as ILocalizationProvider;
            if (value != null)
        ...
        ~LocalizeDictionary()
        {
            LocalizationResourceExtension.ClearResourceBuffer();
        ...
        {
            get { return _culture ?? (_culture = DefaultCultureInfo); }
            set
            {
        ...
        {
            get { return _setCurrentThreadCulture; }
            set
            {
        ...
        {
            get { return _includeInvariantCulture; }
            set
            {
        ...
        public ObservableCollection<CultureInfo> MergedAvailableCultures
        {
            get
            {
                ...
                {
                    _mergedAvailableCultures = new ObservableCollection<CultureInfo>();
                    _mergedAvailableCultures.Add(CultureInfo.InvariantCulture);
        ...
        {
            get { return CultureInfo.CreateSpecificCulture(Culture.ToString()); }
        }
